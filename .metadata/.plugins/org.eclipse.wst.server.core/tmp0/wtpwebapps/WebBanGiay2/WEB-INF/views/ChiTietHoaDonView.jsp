...
<body>
	...
	<div class="container">
		<h1 id="id" data-value="${hoaDonDTO.getId() }" style="text-align: center;margin-top: 30px">Chi tiết hóa đơn: ${hoaDonDTO.getId() } - 
			<c:choose>
	...
	<script type="text/javascript" src='<c:url value="/resources/js/ChiTietHoaDon.js" />'></script>
</body>
</html>