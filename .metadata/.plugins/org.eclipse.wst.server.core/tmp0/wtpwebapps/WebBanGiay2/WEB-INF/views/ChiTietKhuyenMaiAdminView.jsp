...
<body>
	...
	<div class="container" style="margin-top: 5%">
		<div>
			...
			<input data-value="${khuyenMaiDTO.getId() }" class="form-control" type="text" placeholder="Tên khuyến mãi" id="tenKhuyenMai" value="${khuyenMaiDTO.getTenKhuyenMai() }"/>
			<span id="errorTenNguoiDung" style="color: red"></span>

			<div style="margin-top: 30px;margin-bottom: 10px">Ngày bắt đầu: </div>
			<input class="form-control" type="date" id="ngayBatDau" value="${khuyenMaiDTO.getNgayBatDau() }"/>
			<span id="errorTenNguoiDung" style="color: red"></span>
			<div style="margin-top: 30px;margin-bottom: 10px">Ngày kết thúc: </div>
			<input class="form-control" type="date" id="ngayKetThuc" value="${khuyenMaiDTO.getNgayKetThuc() }"/>
			<span id="errorTenNguoiDung" style="color: red"></span>
			<div style="margin-top: 30px;margin-bottom: 10px">Phần trăm: </div>
			<input class="form-control" type="number" id="phanTram" value="${khuyenMaiDTO.getPhanTram() }"/>
			<span id="errorTenNguoiDung" style="color: red"></span>
			<div class="container">
	...
	<nav aria-label="Page navigation example" style="margin: 0 auto">
			...
			<br/>
			<button id="btnSuaKhuyenMai" type="button" class="btn btn-dark" style="width: 100%;margin-bottom: 20px;margin-top: 50px">Sửa khuyến mãi</button>
			<button id="btnXoaKhuyenMai" type="button" class="btn btn-danger" style="width: 100%;margin-top: 50px">Xóa khuyến mãi</button>
			
		</div>
	
		<script type="text/javascript" src='<c:url value="/resources/js/ChiTietKhuyenMaiAdmin.js" />'></script>
