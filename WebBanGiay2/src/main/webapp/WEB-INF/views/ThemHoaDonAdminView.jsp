...
<body>
	...
	<div class="container">
		<h1 style="text-align: center;margin-top: 30px">Thêm hóa đơn</h1> 

		<h3 style="margin-left: -200px;">Thông tin người nhận</h3>
		<div class="row" style="margin-left: -200px;margin-right: -200px">
					
					<div style="width: 100%">Tên người nhận: </div>
					<input type="number" class="form-control" id="giaTien" placeholder="Nhập tên người nhận" >
